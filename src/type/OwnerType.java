...
abstract class OwnerType extends AbstractType implements Type {
  ...
  /**
   * Returns the corresponding Dart compiler resolved element.
   * A owner type has only one corresponding class element but
   * one class element can correspond to many types. 
