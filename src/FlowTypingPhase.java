...
public class FlowTypingPhase implements DartCompilationPhase {
	...
	public DartUnit exec(DartUnit unit, DartCompilerContext context, CoreTypeProvider coreTypeProvider) {
	  ...
	  CoreTypeRepository coreTypeRepository = CoreTypeRepository.createCoreTypeRepository(coreTypeProvider);
    ...
    @Override
		...
		@Override
		public Type visitBinaryExpression(DartBinaryExpression node, FlowEnv flowEnv) {
