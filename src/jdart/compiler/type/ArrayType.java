...
public class ArrayType extends NullableType {
   ...
   * @param constantItemTypes a list of type of array components.
  ...
  /**
   * Creates a type representing an array of type with a component type and a length.
   * @param componentType the component type of this array
  ...
  public int hashCode() {
    return (isNullable() ? 1 : 0) ^
        length.hashCode() ^
        Objects.hashCode(constantItemTypes) ^
        Integer.rotateLeft(componentType.hashCode(), 16);
  }
  ...
  public boolean equals(Object obj) {
    ...
    return isNullable() == arrayType.isNullable() &&
        componentType.equals(arrayType.componentType) &&
        Objects.equals(length, arrayType.length) &&
